...
**Command-Option-M**          | **最小化最前端应用的所有窗口**
**Command-Option-H**          | **查看最前端的应用但隐藏所有其他应用**
**Command-W**                 | **关闭最前端的窗口**
**Command-Option-W**          | **关闭该应用的所有窗口**
...
Command-S                     | 存储当前文稿
Command-Q                     | 退出应用
Command-Option-Esc            | 强制退出：选择要强制退出的应用
...
Shift–Control–（电源按钮或介质推出键 )               | 将显示器置于睡眠状态。
Command–Control–介质推出键 	                      | 退出所有应用，然后重新启动 Mac。如果任何打开的文稿有未存储的更改，系统将询问您是否要存储这些更改。
Command–Option–Control–（电源按钮或介质推出键 ）	   | 退出所有应用，然后关闭 Mac。如果任何打开的文稿有未存储的更改，系统将询问您是否要存储这些更改。
...
Fn-Delete	          | 在没有向前删除键   的键盘上向前删除。也可以使用 Control-D。
...
**Command-Shift-H**		                     | **打开当前 OS X 用户帐户的个人文件夹**
...
**Command-Option-Y**		                     | **查看所选文件的快速查看幻灯片显示**
...
Command-Shift-T		                     | 将所选的 Finder 项目添加到 Dock（OS X Mountain Lion 或较早版本）
...
⌘ + 1 到 ⌘ + 8                    |跳转到特定标签页
⌘ + 9                             |跳转到最后一个标签页
⌘ + [ 或 ⌘ + 向左箭头键             |打开当前标签页浏览记录中记录的上一个页面
⌘ + ] 或 ⌘ + 向右箭头键             |打开当前标签页浏览记录中记录的下一个页面
⌘ + Shift + b                     |显示或隐藏书签栏
⌘ + Option + b                    |打开书签管理器
⌘ + ,                             |在新标签页中打开“设置”页
⌘ + y							   |在新标签页中打开“历史记录”页
⌘ + Shift + j						|在新标签页中打开“下载内容”页
⌘ + Option + i						|打开“开发者工具”
